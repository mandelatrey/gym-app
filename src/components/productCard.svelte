...
<div class="grid grid-cols-1 md:grid-cols-2 gap-14 md:gap-14 lg:gap-20 relative text-base pl-10 pr-10 pt-10">
    <div class={"flex flex-col gap-8 md:gap-10 pt-8 sm:pt-10" + (index % 2 === 1 ? " md:order-2 ": " ")} >
        ...
        <div class={"flex flex-col dropShadow overflow-hidden rounded-b-lg" + (index % 2 === 1 ? " order-2 ": " ")}>
                <div class="rounded-t-xl h-8 sm:h-10 bg-white opcaity-60 px-3 flex items-center gap-2">
                    {#each [1,2,3] as i}
